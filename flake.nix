  ...
  outputs = inputs@{ self, ... }:
    let
      ...
      userSettings = rec {
        ...
        name = "Fabrice Semti"; # name/identifier
        email = "fabrice@fabricesemti.com"; # email (used for certain configurations)
        dotfilesDir = "~/projects/nix-config"; # absolute path of the local repo
